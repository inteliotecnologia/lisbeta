...
class PDF_HTML extends FPDF
{
	...
	function SetStyle($tag,$enable)
	{
		...
		if ($enable) {
			if (($tag=="B") || ($tag=="STRONG")) $this->SetFont("ARIAL", "B");
			elseif (($tag=="I") || ($tag=="EM")) $this->SetFont("ARIAL_N_ITALICO");
			else $this->SetFont('ARIAL','');
		}
		else {
			if (($tag=="B") || ($tag=="STRONG")) $this->SetFont("ARIAL");
			elseif (($tag=="I") || ($tag=="EM")) $this->SetFont("ARIAL");
			else $this->SetFont('ARIAL','');
		}
