...
function perguntaDatas() {
	//alert(1);
	var intervalo= prompt("Digite o texto referente ao intervalo dos recibos.");
	var data_impressao= prompt("Digite a data de impressão.");
	
	window.open("index2.php?pagina=rh/recibos_relatorio_voluntarios&intervalo="+intervalo+"&data_impressao="+data_impressao);
...
function avaliaServicoRM(id_rm, id_rm_andamento, campo, nota) {
	...
	var confirma= confirm("Tem certeza que deseja dar nota "+nota+" para o serviço executado?"+mensagem_adicional);
