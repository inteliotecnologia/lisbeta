...
<form action="<?= AJAX_FORM; ?>formFuncionario&amp;acao=<?= $acao; ?>" enctype="multipart/form-data" method="post" name="formFuncionario" id="formFuncionario" onsubmit="return validaFormNormal('validacoes', true);">
	...
	<input class="escondido" type="hidden" id="validacoes" name="validacoes" value="id_departamento@vazio|id_turno@vazio|id_cargo@vazio|data_admissao@data|nome@vazio|sexo@vazio|id_cidade@vazio" />
    <? if ($acao=='e') { ?>
    ...
    <fieldset>
        ...
        <div class="parte50">
            ...
            <input type="hidden" name="id_empresa_rel" value="6" />
            <?
            /*
        ...
        <div class="parte50">
            ...
            */ ?>
            ...
            <label for="oficial">Contrato:</label>
            <select name="oficial" id="oficial">
            	<option value="1" <? if ( ($rs->oficial=="1") || ($acao=='i') ) echo "selected='selected'"; ?>>Oficial</option>
            	<option value="2" <? if ($rs->oficial=="2") echo "selected='selected'"; ?>>Voluntário</option>     	
            </select>
            <br />
        </div>
    </fieldset>
    ...
    <fieldset>
        ...
        <div class="parte50">
            <label for="tit_eleitor">Tit. eleitor:</label>
            <input title="Título de eleitor" name="tit_eleitor" id="tit_eleitor" value="<?= $rs->tit_eleitor; ?>" />
            <br />
            ...
            <label for="obs_gerais">OBS:</label>
            <textarea name="obs_gerais" id="obs_gerais"><?= $rs->obs_gerais; ?></textarea>
            <br />
...
*/ ?>
    ...
    <fieldset>
        ...
        <div class="parte50">
            ...
            <input name="telefone" id="telefone" value="<?= $rs->telefone; ?>" onkeypress="return formataCampo(form, this.name, '(99) 9999-9999', event);" maxlength="14" />
            <br />
            ...
            <label for="site">Site/facebook:</label>
            <input name="site" id="site" value="<?= $rs->site; ?>" />
            <br />
            
            <label for="tamanho_uniforme">Tamanho camiseta:</label>
