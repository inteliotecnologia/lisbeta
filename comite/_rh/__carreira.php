    ...
    <legend>Carreira do funcionário na empresa</legend>
        ...
        <tr <? if ($rs->atual==1) echo "class=\"cor_sim\""; ?>>
            ...
            <td valign="top">
                ...
                <a onmouseover="Tip('Contrato de prestação de serviços');" href="index2.php?pagina=rh/documento&amp;id_funcionario=<?=$rs->id_funcionario;?>&amp;tipo=14&amp;id_carreira=<?= $rs->id_carreira; ?>" target="_blank">
