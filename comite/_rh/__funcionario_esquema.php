...
<h2>Colaborador - <?= pega_funcionario($_GET["id_funcionario"]); ?></h2>
...
<div class="div_abas screen" id="aba_opcoes_funcionario">
    <ul class="abas">
        ...
        <li id="aba_funcionario_recibo"><a href="javascript:void(0);" onclick="atribuiAbaAtual('aba_funcionario_recibo', 'aba_opcoes_funcionario'); ajaxLink('conteudo_interno', 'carregaPagina&amp;pagina=rh/carreira&amp;id_funcionario=<?= $_GET["id_funcionario"]; ?>');">Recibo</a></li>
