...
<div class="parte_esquerda">
	...
	<form action="<?= AJAX_FORM ?>formContato" method="post" name="formContato" id="formContato" onsubmit="return ajaxForm('conteudo', 'formContato');">
		...
		<label>E-mail:</label>
		<input name="email" id="email" value="<?= pega_email_pelo_id_usuario($_SESSION["id_usuario_sessao"]); ?>" onmouseover="Tip('Informe seu e-mail, para que possamos entrar em contato.');"  />
		<br />
		...
		<select name="tipo_contato" id="tipo_contato" onmouseover="Tip('Selecione o tipo do contato.');" />
			...
			<option value="Dúvida" class="cor_sim">Dúvida</option>
			<option value="Sugestão">Sugestão</option>
			<option value="Reclamação" class="cor_sim">Reclamação</option>
		...
		<select name="area_contato" id="area_contato" onmouseover="Tip('Selecione a área do sistema referente ao contato.');" />
			<option value="">--- selecione ---</option>
			<option value="Prontuário" class="cor_sim">Prontuário</option>
			<option value="Consultas">Consultas</option>
			<option value="Cadastro de pessoas" class="cor_sim">Cadastro de pessoas</option>
			<option value="Almoxarifado">Almoxarifado</option>
			<option value="Consultas" class="cor_sim">Consultas</option>
			<option value="Remédios">Remédios</option>
			<option value="Exames" class="cor_sim">Exames</option>
            <option value="TFD">TFD</option>
            <option value="Produção" class="cor_sim">Produção</option>
			<option value="Outros">Outros</option>
		</select>
		<br />

		<label>Mensagem:</label>
		<textarea class="grandao" name="mensagem" id="mensagem" onmouseover="Tip('Digite a mensagem.');"></textarea>
		<br />
...
<div class="parte_direita">
	...
	<ul class="recuo1">
		<li>
			<span class="texto_destaque">Jaison Niehues</span> (48) 9904.2710 <br />
		...
		<li>
			<span class="texto_destaque">Jean Carlos Niehues</span> <br />
			<a href="mailto:jean@lisbeta.net">jean@lisbeta.net</a> <br />
			Bacharel em Design Industrial
		</li>
	</ul>
</div>
<? } ?>