...
if ($_SESSION["tipo_usuario_sessao"]=="a") {
	...
	$sql .= " order by id_cidade, veiculo ";
...
<h2 class="titulos">Veículos</h2>

<a id="botao_voltar" href="javascript:void(0);" onclick="ajaxLink('conteudo', 'carregaPagina&amp;pagina=_veiculos/veiculo_listar&amp;tudo');">listagem completa</a>
...
<div class="parte_esquerda">
	...
	<table cellspacing="0">
		<tr>
			<th width="10%">Cód.</th>
			<th align="left" width="45%">Veículo</th>
		...
		<tr class="corzinha">
			...
			<td>
				<a href="javascript:void(0);" onclick="ajaxLink('div_direita', 'carregaPaginaInterna&amp;pagina=_veiculos/veiculo_editar&amp;id_veiculo=<?= $rs->id_veiculo; ?>');" class="link_editar" title="Editar">editar</a>
				<a onclick="return confirm('Tem certeza que deseja excluir o veículo \'<?= $rs->veiculo; ?>\' do sistema?');" href="javascript:ajaxLink('conteudo', 'veiculoExcluir&amp;id_veiculo=<?= $rs->id_veiculo; ?>');" class="link_excluir" title="Excluir">excluir</a>
			</td>
		</tr>
		<? $i++; } ?>
	</table>
...
<?
	if ($total_linhas>0) {
		if ($num_paginas > 1) {
			$texto_url= "carregaPagina&amp;pagina=_veiculos/veiculo_listar&amp;txt_busca=". $txt_busca ."&amp;lugar=". $lugar ."&amp;num_pagina=";
...
<div class="parte_direita2" id="div_direita">
	<?
	$pagina= "_veiculos/veiculo_inserir";
	include("index2.php");
	?>
</div>
