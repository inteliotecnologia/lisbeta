...
<div class="parte50">
    <fieldset>
        ...
        <?= "<a href=\"javascript:void(0);\" onclick=\"ajaxLink('conteudo', 'carregaPagina&amp;pagina=_pessoas/pessoa_ver&amp;id_pessoa=". $rs->id_pessoa ."');\">". $rs->nome ."</a>"; ?>
        <br />
        ...
        <label>Origem:</label>
        <?= pega_origem_consulta($rs->origem_consulta); ?>
        <br />
        ...
        ?>
            ...
            <label>Tipo:</label>
            <?= pega_tipo_consulta($rs_fila->tipo_consulta); ?>
            <br />
            ...
            <label>Residente na área:</label>
            <?= sim_nao($rs_fila->area_abran); ?>
            <br />
        ...
        ?>
            ...
            <label>Tipo:</label>
            <?= pega_tipo_consulta($rs_ag->tipo_consulta); ?>
            <br />
            
            <label>Data (agend.):</label>
            <?= $rs_ag->data_agendamento; ?>
            <br />
    ...
    <fieldset>
        ...
        <label>Tipo:</label>
        <?= pega_tipo_consulta_prof($rs->tipo_consulta_prof); ?>
        <br />
