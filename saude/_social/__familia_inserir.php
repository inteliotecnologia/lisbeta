...
<h2 class="titulos">Inserção de família - Dados sócio-econômicos</h2>
<br />
...
<form action="<?= AJAX_FORM; ?>formFamiliaInserir" method="post" id="formFamiliaInserir" name="formFamiliaInserir" onsubmit="return ajaxForm('conteudo', 'formFamiliaInserir');">
    ...
    <fieldset>
        ...
        <div class="partei">
            ...
            <input type="radio" name="vacina" id="vacina_n" value="n" class="tamanho20" /> <label class="label_check" for="vacina_n">Não</label>
            <br />
