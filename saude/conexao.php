...
if ($_SERVER['SERVER_NAME']=="localhost") {
	...
	$conexao= @mysql_connect("enceladus.cle1tvcm29jx.us-east-1.rds.amazonaws.com", "intelio_user", "2i92iS02iV3d23dm") or die("O servidor está um pouco instável, favor tente novamente mais tarde!");
	@mysql_select_db("lisbetasaude_db") or die("O servidor está um pouco instável, favor tente novamente mais tarde!!". mysql_error());
}
...
if (($_GET["pagina"]!="login") && ($_GET["pagina"]!="esqueci_senha")) {
	...
	//echo $_SESSION["id_usuario_sessao"]."a"; die();
